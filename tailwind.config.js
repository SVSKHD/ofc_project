...
export default {
  ...
  theme: {
    extend: {
      backgroundImage: {
        'hero-gradiented':
          'url("backgrounds/hero/hero-centered-gradient-mobile.svg")',
        'hero-tablet': 'url("backgrounds/hero/hero-tablet.svg")',
        'hero-desktop': 'url("backgrounds/hero/hero-desktop.svg")',
        'game-detail': 'url("backgrounds/gameDetailBackground.png")',
        'blue-gradient': 'linear-gradient(90deg, #08227B 0%, #036AA3 100%)',
        'dark-green': 'linear-gradient(160deg, #20331F 0%, #1C271B 25%, #171717 50%, #1C271B 75%, #20331F 100%)',
